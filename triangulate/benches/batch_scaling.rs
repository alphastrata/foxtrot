...
use triangulate::triangulate::{build_transform_stack, collect_faces_from_brep, presentation_style_color, transform_stack_roots};
    ...
    for &batch_size in &batch_sizes {
        ...
        group.bench_with_input(
            ...
            |b, _files| {
                ...
                b.iter(|| {
                    // This replicates the wgpu_triangulate_batch_from_examples logic
                    ...
                    for path in &step_files {
                        if let Ok(contents) = fs::read(path) {
                            ...
                            let (_mesh, _stats) = wgpu_impl::triangulate_faces_with_device(&step_file, &face_tasks, &device, &queue);
                        }
                    }
                });
            },
