//! Historical triangulation implementations for benchmarking and comparison
//!
//! This module contains previous implementations of the triangulation algorithm
...
impl<'a> EntityCache<'a> {
    ...
    fn clone_for_thread(&self) -> Self {
        EntityCache {
            ...
            axis2_placements: self.axis2_placements.clone(),
...
fn edge_loop2(
    ...
    for (i, e) in edge_list.iter().enumerate() {
        ...
        let o = edge_curve2(s, cache, edge.edge_element.cast(), edge.orientation)?;
...
fn edge_curve2(
    ...
    let curve = curve2(s, cache, &edge_curve, edge_curve.edge_geometry, orientation)?;
